  ...
  <article class="card relative" :class="classes" @click="$emit('click')">
    ...
    <main class="body">
      <div class="details flex flex-col gap-2">
        ...
        <div class="edit text-brand-gray-800 mt-auto flex gap-2" @click="$emit('editClick')" v-if="isCurrentUser">
...
.card {
  .more {
    @apply text-xs text-brand-gray-400 absolute bottom-0 left-0 right-0 text-center;
  }
  .head {

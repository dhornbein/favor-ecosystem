  ...
  <article class="card relative" :class="classes" @click="$emit('click')">
    ...
    <header class="head">
      ...
      <div v-if="mine" class="my edit ml-auto flex gap-2 items-center">
        ...
        <button class="btn btn-sm" @click="$auth.logout()" v-if="isCurrentUser">Logout</button>
      </div>
    </header>
    ...
    <main class="body">
      <div class="details">
        ...
        <div class="edit text-gray-700 mt-4 flex gap-2" @click="$emit('editClick')" v-if="isCurrentUser">

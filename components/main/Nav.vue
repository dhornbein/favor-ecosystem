<template>
  <header class="main-nav">
    <nav class="flex justify-around items-center gap-4">
      <nuxt-link to="/" class="home flex-shrink">
      ...
      <nuxt-link to="/transactions">
        ...
        <span class="hidden sm:inline">Dealings</span>
      </nuxt-link>
      <nuxt-link class="text-green-700" to="/invite">
...
.main-nav {
  @apply w-screen bg-white shadow-lg border-b border-brand-primary z-30;
}
...
nav a {
  @apply border-b-2 p-2 border-white;
  svg {
    @apply stroke-current inline-block
  }
}
</style>